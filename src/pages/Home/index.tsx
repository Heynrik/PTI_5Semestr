...
import Carousel, { CarouselItem } from 'react-native-snap-carousel';
...
const Home: React.FC<HomeProps> = () => {
    ...
    // Função para lidar com o evento onPress
    const handleAgendamentoPress = () => {
        navigation.navigate('NomeDaSuaTela'); // Substituir 'NomeDaSuaTela' pelo nome da tela para a qual deseja navegar
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <Text style={styles.texto2}>Conectamos Nutricionistas e Pacientes!</Text>
                <Image style={styles.contexto} source={require('../../assets/paginaInicial.png')} />
            </View>
            <View>
                <Text style={styles.texto3}>Vantagens de utilizar nossa plataforma:</Text>
            </View>
            <Carousel
                data={carouselItems}
                sliderWidth={400}
                ...
                useScrollView={true}
            />
            {/* TouchableOpacity com evento onPress */}
